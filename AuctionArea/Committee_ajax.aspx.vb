...
Partial Class AdminConfig_Committee_ajax
    ...
    Public Shared Function AddCommittee(ByVal vEventId As String, ByVal vMemberTypeId As Integer,
        ...
        cmd.Parameters.Add(New OracleParameter("vAnnouncerId", OracleDbType.NVarchar2)).Value = "0"
        cmd.Parameters.Add(New OracleParameter("vOfficerId", OracleDbType.NVarchar2)).Value = "0"
