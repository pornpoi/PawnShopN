<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ControlSublud.aspx.vb" Inherits="AuctionArea_ControlSublud" %>
            ...
            <div class="modal-dialog modal-lg ">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">ข้อมูลคณะกรรมการควบคุมการจำหน่ายทรัพย์หลุดจำนำ</h4>
                    </div>
...
//                }
    ...
    function addCommittRow(num, empId) {
        ...
        comittCont += "<label class=\"control-label col-sm-2\" for=\"pwd\">ควบคุมทรัพย์คนที่ " + num + ":</label>";
